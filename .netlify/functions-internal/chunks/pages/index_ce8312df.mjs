import { e as createAstro, f as createComponent, r as renderTemplate, h as renderHead, g as renderComponent, i as addAttribute } from '../astro_8119f959.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./blog/post-1.md": () => import('./post-1_5f040c53.mjs'),"./blog/post-2.md": () => import('./post-2_338b2cf9.mjs'),"./blog/post-3.md": () => import('./post-3_ea58cbe4.mjs')}), () => "./blog/*.md");
