...
import { manifest } from './manifest_771cda8d.mjs';

const _page0  = () => import('./chunks/generic_4ce5cfaf.mjs');
const _page1  = () => import('./chunks/index_dcf18fdb.mjs');
